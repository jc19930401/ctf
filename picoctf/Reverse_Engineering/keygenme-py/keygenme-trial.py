...
(d) Exit Arcane Calculator")
    ...
    print("FLAG is here:")
    print(str(key_part_static1_trial)+str(hashlib.sha256(bUsername_trial).hexdigest()[4])+str(hashlib.sha256(bUsername_trial).hexdigest()[5])+str(hashlib.sha256(bUsername_trial).hexdigest()[3])+str(hashlib.sha256(bUsername_trial).hexdigest()[6])+str(hashlib.sha256(bUsername_trial).hexdigest()[2])+str(hashlib.sha256(bUsername_trial).hexdigest()[7])+str(hashlib.sha256(bUsername_trial).hexdigest()[1])+str(hashlib.sha256(bUsername_trial).hexdigest()[8])+str(key_part_static2_trial))
